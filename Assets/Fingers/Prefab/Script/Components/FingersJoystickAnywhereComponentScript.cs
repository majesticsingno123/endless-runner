...
namespace DigitalRubyShared
{
    ...
    public class FingersJoystickAnywhereComponentScript : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            //print("Touches " + tapGesture.TapTouches.Count);
            //print("Touches " + panGesture.Enabled + " - " + panGesture.CurrentTrackedTouches.Count);
            //print("crossPlatformInputAxisMoveNewlyRegistered " + crossPlatformInputAxisJumpNewlyRegistered);
        }
